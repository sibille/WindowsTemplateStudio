...
namespace Microsoft.Templates.UI.Launcher
{
    public class WizardLauncher
    {
        ...
        public UserSelection StartNewProject(string platform, string language, IEnumerable<string> requiredWorkload, BaseStyleValuesProvider provider)
        {
            ...
            {
                var newProjectView = new Views.NewProject.WizardShell(platform, language, requiredWorkload, provider);
