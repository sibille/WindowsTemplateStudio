...
namespace Microsoft.Templates.Core.Gen
{
    public class GenComposer
    {
        ...
        private static void AddTemplates(IEnumerable<ItemInfo> templates, List<GenInfo> genQueue, UserSelection userSelection, bool newItemGeneration)
        {
        ...
        private static void AddDependencyTemplates(ItemInfo selectionItem, List<GenInfo> genQueue, UserSelection userSelection, bool newItemGeneration)
        {
