...
namespace Microsoft.Templates.Core.Gen
{
    ...
    public class UserSelection
    {
        ...
        public List<ItemInfo> Pages { get; } = new List<ItemInfo>();

        public List<ItemInfo> Features { get; } = new List<ItemInfo>();

        public IEnumerable<ItemInfo> PagesAndFeatures
        {
            get
            {
        ...
        public void Add(ItemInfo template)
        {
